...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: The contract guarantees that `address` is a valid pointer to a u32 value.
    // We cast the address to a mutable pointer and dereference it to modify the value.
    unsafe {
